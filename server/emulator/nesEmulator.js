...
var rom_data = fs.readFileSync('./emulator/rom/Legend_of_Zelda.nes', {encoding: 'binary'});
...
//REPLACE THE BELOW FUNCTION'S XMLHTTP WITH A DATA CALLBACK FROM INITIAL CONNECT FROM THE SERVER WITH ROM INFO
