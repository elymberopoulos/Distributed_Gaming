...
function init() {
    ...
    var isP2PInitiator = false; //Boolean check for the first peer created. emits special hash code signals
    var peer; //peer object initialized later based on href location to either generate initiator or generic peer
